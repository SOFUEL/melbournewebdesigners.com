  ...
  <div class="wrap funnel-inner">
    ...
    <div class="result-state" id="state-thanks" role="status">
      ...
      <div id="thanks-book" class="hide">
        ...
        <a class="btn btn-primary" href="https://calendly.com/joel-socialfuel/free-30-minute-strategy-session" target="_blank" rel="noopener">Book a 30-minute call <span class="arr">${ICON_ARROW}</span></a>
